...
const About = () => {
  return (
    <section id="about" className="about bg-black p-8">
      <div className="container" data-aos="fade-up">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 pt-4 lg:pt-0 content">
            ...
            <ul className="list-disc list-inside mb-4">
              <li className="flex items-start mb-2 ">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="size-6 mt-1 mr-2 text-primary"
                >
                  <path
                    fillRule="evenodd"
            ...
            <p>
              ...
              omnis facere. Sunt ipsum dignissimos illo aspernatur veritatis
              asperiores. Quia aut quasi autem, eum tempora voluptas!
            </p>
          </div>
        </div>
      </div>
